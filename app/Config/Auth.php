...
class Auth extends ShieldAuth
{
     ...
     */
    public array $views = [
        // Vues custom CyberRun (themees cyberpunk via layouts/main)
        'login'                       => 'auth/login',
        'register'                    => 'auth/register',
        'magic-link-login'            => 'auth/magic-link-login',
        'magic-link-message'          => 'auth/magic-link-message',

        // Vues encore par defaut Shield (a themer si on active 2FA / email activation plus tard)
